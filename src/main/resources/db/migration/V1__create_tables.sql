...
(
    ...
    address           VARCHAR(255),
    member_ship_level VARCHAR(255)                             NOT NULL,
...
ALTER TABLE loans
    ADD CONSTRAINT FK_LOANS_ON_BOOK FOREIGN KEY (book_id) REFERENCES books (id);

ALTER TABLE loans
    ADD CONSTRAINT FK_LOANS_ON_MEMBER FOREIGN KEY (member_id) REFERENCES members (id);
