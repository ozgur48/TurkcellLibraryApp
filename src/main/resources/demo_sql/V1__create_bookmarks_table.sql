...
ALTER TABLE book
    ADD CONSTRAINT FK_BOOK_ON_AUTHOR FOREIGN KEY (author_id) REFERENCES authors (id);

ALTER TABLE book
    ADD CONSTRAINT FK_BOOK_ON_PUBLISHER FOREIGN KEY (publisher_id) REFERENCES publishers (id);
...
ALTER TABLE reservations
    ADD CONSTRAINT FK_RESERVATIONS_ON_BOOK FOREIGN KEY (book_id) REFERENCES book (id);
