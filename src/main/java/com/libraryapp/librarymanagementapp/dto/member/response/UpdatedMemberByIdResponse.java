...
public class UpdatedMemberByIdResponse {
    private String name;
    ...
    public UpdatedMemberByIdResponse(String name, String email, String phone, String address, MemberShipLevel memberShipLevel, MemberStatus memberStatus) {
        this.name = name;
        this.email = email;
        this.phone = phone;
        this.address = address;
